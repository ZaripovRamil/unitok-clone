...
namespace Persistence.Migrations
{
    ...
    [Migration("20230519160851_ChangeDefaultPfp")]
    partial class ChangeDefaultPfp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Balance = 0m,
                            ConcurrencyStamp = "5f2d5c14-1e0c-433c-a7db-943769f6aedb",
                            ...
                            ProfilePicUrl = "default_pfp.jpg",
                            Role = 0,
                            SecurityStamp = "d735ecb7-bcad-46ca-9063-dbf701657f98",
            ...
            modelBuilder.Entity("Domain.ActivityLogs.TokenCreationLog", b =>
                {
                    b.HasOne("Domain.Entities.User", "Author")
                        .WithMany("TokenCreationLogs")
                        .HasForeignKey("AuthorId");

                    b.HasOne("Domain.Entities.Token", "Token")
                        .WithOne("TokenCreationLog")
                        .HasForeignKey("Domain.ActivityLogs.TokenCreationLog", "TokenId")
            ...
            modelBuilder.Entity("Domain.Entities.Token", b =>
                {
                    b.Navigation("TokenAuctions");

                    b.Navigation("TokenCreationLog")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("ParticipationLogs");

                    b.Navigation("SellLogs");

                    b.Navigation("TokenCreationLogs");
                });
